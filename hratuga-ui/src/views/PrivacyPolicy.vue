    ...
    <v-row>
      <v-col>
        ...
        <h3>Datenerfassung auf dieser Website</h3> <h4>
          ...
          Website betreten.
        </p> <h4>Wof&uuml;r nutzen wir Ihre Daten?</h4> <p>
        ...
        </p> <h4>Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>
        <p>
        ...
        <h3>Host Europe</h3> <p>
          Anbieter ist die Host Europe GmbH, Hansestra&szlig;e 111, 51149, K&ouml;ln
          (nachfolgend Host Europe) Wenn Sie unsere Website besuchen, erfasst Host Europe verschiedene Logfiles inklusive
          Ihrer IP-Adressen.
        </p> <p>
          Details entnehmen Sie der Datenschutzerkl&auml;rung von Host Europe: <a
...
noreferrer"
          ...
          Endger&auml;t des Nutzers (z.&nbsp;B. f&uuml;r Device-Fingerprinting) im Sinne des TTDSG umfasst. Die
        ...
        <h3>Hinweis zur verantwortlichen Stelle</h3> <p>
          ...
          Pfadfinderstamm Hratuga<br>
          Brachterstr. 1<br>
          40882 Ratingen
        </p>
        <p>
          E-Mail: stamm [ at ] hratuga.de
        </p>
        <p>
        ...
        <h3>Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3> <p>
          Sofern Sie
        ...
        <h3>Empfänger von personenbezogenen Daten</h3> <p>
        ...
        <h3>Auskunft, Berichtigung und L&ouml;schung</h3> <p>
